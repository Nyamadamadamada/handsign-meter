...
const StepContent = ({ step, todayMode }: Props) => {
  ...
  // step2: OKサイン後でSTEP２に切り替わる。「今日の気分を５段階で表してね。5が最も調子が良いよ」というテキストがcanvasに表示される
  ...
  return (
    <Stack className="overlay" display={'flex'}>
      {step === 'STEP1' && (
        <>
          <Text>準備ができたらOKサインを出して!</Text>
          <Image className="pop-once" width="1/3" marginTop={'10%'} src="img/ok_icon.png" alt="OKサインアイコン" />
        </>
      )}
      {step === 'STEP2' && (
        <>
